...
export default function JarvisOrb() {
  ...
  const startListening = useCallback(() => {
    // Mobile Audio Unlocker: Forces the browser to unlock the speaker
    ...
    recognition.onresult = async (event: any) => {
      ...
      // Play speech directly without alert popups
        if (data.text) {
          speakResponse(data.text);
        } else {
          console.error("API Error: ", data.error || "Check Vercel Logs");
        }
  ...
  }, [toggleGestures, isListening, startListening]);
  ...
  return (
    <>
      ...
      {isListening && <div className="hud-title" style={{ top: "48px", color: "#ff5533" }}>LISTENING...</div>}
      {isThinking && <div className="hud-title" style={{ top: "48px", color: "#ffcc66" }}>PROCESSING...</div>}
      ...
      <div className="hud hud-controls">
        ...
        <div className="hud-row">
          ...
          >
            {isListening ? "LISTENING..." : isThinking ? "THINKING..." : "VOICE (V)"}
          </button>
        </div>
        ...
        <div className="hud-row">
          ...
          >
            {camera === "starting" ? "INIT..." : cameraOn ? "GESTURES ON" : "GESTURES OFF"}
          </button>
        </div>
        <div className="hud-row">
